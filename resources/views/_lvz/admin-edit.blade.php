<x-l-layout::form :action="route('app.admin.update', $user->id)">
    ...
    <x-l::form-input name="adminEditName" type="text" :value="$user->name"/>
    <p class="formFormP">
        Email
    </p>
    <x-l::form-input-error :messages="$errors->get('adminEditEmail')"/>
    <x-l::form-input name="adminEditEmail" type="text" :value="$user->email"/>
    <p class="formFormP">
        Пароль
    </p>
    ...
    <x-l::form-input-check name="adminEditAdmin" :checked="$roles['admin']">
        Администратор
